       ...
       <div className="overflow-x-auto">
          ...
          <div className="bg-gray-50 px-6 py-4">
            <div className="grid grid-cols-9 gap-4 text-sm font-medium text-gray-700">
              <div className="col-span-1 min-w-[100px]">WO #</div>
              <div className="col-span-2 min-w-[250px]">Work Order Title</div>
              <div className="col-span-1 min-w-[100px]">Image</div>
              <div className="col-span-1 min-w-[180px]">Due Date</div>
              <div className="col-span-1 min-w-[120px]">Status</div>
              <div className="col-span-1 min-w-[120px]">Priority</div>
              <div className="col-span-1 min-w-[100px]">Cost</div>
              <div className="col-span-1 min-w-[150px]">Assignees</div>
           ...
           {/* Table Body */}
              ...
              {workOrders.map((workOrder) => (
                ...
                >
                    ...
                    {/* Work Order Title */}
                    <div className="col-span-2 min-w-[250px]">
                    ...
                    {/* Image */}
                    <div className="col-span-1 min-w-[100px]">
                      <button className="w-10 h-10 bg-gray-200 rounded border border-gray-300 flex items-center justify-center hover:bg-gray-300 transition-colors">
                    ...
                    <div className="col-span-1 min-w-[120px]">
                      <div className="flex items-center gap-2">
                        <div className={`w-3 h-3 rounded-full ${workOrder.status.bgColor}`}></div>
                    ...
                    {/* Priority */}
                    <div className="col-span-1 min-w-[120px]">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${workOrder.priority.bgColor} ${workOrder.priority.color}`}>
                    ...
                    <div className="col-span-1 min-w-[150px]">
                      {workOrder.completedBy ? (
                        <span className="text-gray-700">{workOrder.completedBy}</span>
                      ) : (
