...
const data: CycleCountData[] = [
    { id: 1, name: "Kiểm kê hệ thống ngay...", location: "Suite B", status: "Closed", startDate: "07/01/2025", dueDate: "07/01/2025", counted: "3/3", dateCreated: "3" },
    { id: 2, name: "Test", location: "Suite B", status: "Closed", startDate: "07/01/2025", dueDate: "07/01/2025", counted: "3/3", dateCreated: "3" },
    { id: 3, name: "Nhựa 99", location: "Suite B", status: "Closed", startDate: "07/01/2025", dueDate: "07/01/2025", counted: "3/3", dateCreated: "3" },
    { id: 4, name: "BBC", location: "Upkeep HQ", status: "Closed", startDate: "07/01/2025", counted: "2/2", dateCreated: "3" },
    { id: 5, name: "Linh", location: "Suite B", status: "Closed", startDate: "07/01/2025", counted: "1/1", dateCreated: "3" },
];
                        ...
                        {data.map((row) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{row.counted}</td>
